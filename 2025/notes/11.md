...
So if we compute the number of paths between each pair, and find the product, that's our answer! After the fact, I also realized that for all paths that must include two specific intermediate nodes:
